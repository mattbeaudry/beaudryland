...
export class UI {
	...
	setupUI() {
		...
		[...document.querySelectorAll('.bui-colorpicker .bui-colorpicker-input')].forEach(
			function (el) {
				el.addEventListener('click', function () {
		...
		[...document.querySelectorAll('.bui-colorpicker .bui-colorpalette .bui-swatch')].forEach(
			function (el) {
				el.addEventListener('click', function () {
		...
		[...document.querySelectorAll('.bui-colorpicker .bui-colorpicker-eraser')].forEach(
			function (el) {
				el.addEventListener('click', function () {
		...
		[...document.querySelectorAll('.bui-menu')].forEach(function (el) {
			el.addEventListener('click', function () {
				...
				[...document.querySelectorAll('.bui-menu-dropdown')].forEach(
