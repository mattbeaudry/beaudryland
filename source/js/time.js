	...
	startTime() {
		...
		var animateSpears = function () {
			[...document.querySelectorAll('.the-fucking-spear')].forEach(function (el) {
				...
				switch (direction) {
					case 'up':
						stillmoving = blMovement.moveObject('up', id, 'spear');
						break;
					case 'down':
						stillmoving = blMovement.moveObject('down', id, 'spear');
						break;
					case 'left':
						stillmoving = blMovement.moveObject('left', id, 'spear');
						break;
					case 'right':
						stillmoving = blMovement.moveObject('right', id, 'spear');
						break;
				}
		...
		var waveBlockClasses =
			'block-grass block-rock block-dirt block-fire block-water block-tree block-hole block-wood block-door-closed block-door-open block-diamond-hole block-diamond block-gold-hole block-gold block-pinetree block-icerock block-ice block-snow block-snowhole block-frozendirt block-palmtree block-sandstone block-sand block-wave';
